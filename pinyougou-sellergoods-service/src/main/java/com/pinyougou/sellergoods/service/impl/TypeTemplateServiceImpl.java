	...
	public PageResult findPage(TbTypeTemplate typeTemplate, int pageNum, int pageSize) {
		...
		private void saveToRedis() {
			...
			for(TbTypeTemplate typeTemplate : typeTemplates) {
				...
				Object object = redisTemplate.boundHashOps("brandList").get(typeTemplate.getId());
				List<Map> specList= findTypeTemplate(typeTemplate.getId());
		...
		@Override
		public List<Map> findTypeTemplate(long id) {
